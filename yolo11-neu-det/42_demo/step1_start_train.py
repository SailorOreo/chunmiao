...
#
#cbam模块增加
model = YOLO('yolo11-cbam-GC.yaml').load('D:/YOLO/chunmiao/yolo11-neu-det/42_demo/runs/yolo11n_cbam_GC10/train2/weights/best.pt')
results = model.train(data=DATA_CONFIG_PATH,
                      project="./runs/yolo11n_cbam-GC", epochs=EPOCHS,
                      imgsz=IMAGE_SIZE, device=DEVICE, workers=WORKERS,
                      batch=BATCH, cache=CACHE, amp=AMP)
time.sleep(10)
